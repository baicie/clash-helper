...
export const CLASH_DATA_NAMES: Record<number, ClashDataNameMeta> = {
  ...
  1000033: { en: 'Builder Wall', zh: '城墙', kind: 'builder-building' },
  1000034: {
    en: 'Builder Hall',
    zh: '建筑大师大本营',
    kind: 'builder-building',
  },
  1000035: {
    en: 'Elixir Collector',
    zh: '圣水收集器',
  ...
  1000036: { en: 'Elixir Storage', zh: '圣水瓶', kind: 'builder-building' },
  1000037: { en: 'Gold Mine', zh: '金矿', kind: 'builder-building' },
  1000038: { en: 'Gold Storage', zh: '金库', kind: 'builder-building' },
  1000039: { en: 'Clock Tower', zh: '钟楼', kind: 'builder-building' },
  1000040: {
    en: 'Builder Barracks',
    zh: '建筑大师训练营',
    kind: 'builder-building',
  },
  1000041: { en: 'Double Cannon', zh: '双管加农炮', kind: 'builder-building' },
  1000042: { en: 'Army Camp', zh: '兵营', kind: 'builder-building' },
  1000043: { en: 'Hidden Tesla', zh: '隐形特斯拉', kind: 'builder-building' },
  1000044: { en: 'Cannon', zh: '加农炮', kind: 'builder-building' },
  1000045: { en: 'Multi Mortar', zh: '多管迫击炮', kind: 'builder-building' },
  1000046: {
    en: 'Star Laboratory',
    zh: '星级实验室',
    kind: 'builder-building',
  ...
  1000047: {
    en: 'Master Builder\u0027s Hut',
    zh: '建筑大师小屋',
    kind: 'builder-building',
  },
  1000048: { en: 'Archer Tower', zh: '箭塔', kind: 'builder-building' },
  1000049: {
    en: 'Reinforcement Camp',
    zh: '增援营地',
    kind: 'builder-building',
  },
  1000050: { en: 'Firecrackers', zh: '防空火炮', kind: 'builder-building' },
  1000051: { en: 'Guard Post', zh: '岗哨', kind: 'builder-building' },
  1000052: { en: 'Mega Tesla', zh: '超级特斯拉', kind: 'builder-building' },
  1000053: {
    en: 'Battle Machine Altar',
    zh: '战争机器祭坛',
    kind: 'builder-building',
  },
  1000054: { en: 'Air Bombs', zh: '空中炸弹', kind: 'builder-building' },
  1000055: { en: 'Crusher', zh: '撼地巨石', kind: 'builder-building' },
  1000056: { en: 'Roaster', zh: '熔岩火炮', kind: 'builder-building' },
  1000057: { en: 'Giant Cannon', zh: '巨型加农炮', kind: 'builder-building' },
  1000058: { en: 'Gem Mine', zh: '宝石矿井', kind: 'builder-building' },
  1000063: { en: 'Lava Launcher', zh: '熔岩发射器', kind: 'builder-building' },
  1000064: {
    en: 'B.O.B\u0027s Hut',
    zh: 'B.O.B 小屋',
    kind: 'builder-building',
  ...
  1000078: {
    en: 'O.T.T.O\u0027s Outpost',
    zh: '奥仔岗哨',
    kind: 'builder-building',
  },
  1000080: {
    en: 'Battle Copter Altar',
    zh: '战斗直升机祭坛',
    kind: 'builder-building',
  },
  1000081: { en: 'X-Bow', zh: 'X 连弩', kind: 'builder-building' },
  1000082: { en: 'Healing Hut', zh: '治疗小屋', kind: 'builder-building' },
